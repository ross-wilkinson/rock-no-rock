...
%% Create figure (2x2)
figure('color','w','position',[50 0 450 550])

%% A. Plot image
ax1 = axes('Position',[0 0.5 1 0.5]);

imshow(A(10:end-10,15:end-10,:))
% title('A')
% ax1.Title.HorizontalAlignment = 'left';
% ax1.Title.VerticalAlignment = 'middle';
% ax1.Title.Position = [7, 115, 0];

%% Plot power results
ax2 = axes('Position',[0.1 0.06 0.38 0.42]);
plot(grpPwr)
hold on
...
%% Plot lean results
ax3 = axes('Position',[0.6 0.06 0.38 0.42]);
plot(grpLean)
hold on
set(gca,'ColorOrderIndex',1)
for i = 1:19
